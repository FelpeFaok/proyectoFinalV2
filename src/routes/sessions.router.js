...
import { passportCall, generateToken, authorization, transport, isValidPassword, createHash, validateTokenAndGetID } from '../utils.js';
...
router.get('/logout', (req, res) => {
    // borra la cookie
    res.clearCookie(config.jwtCookieName).redirect('index');
});
